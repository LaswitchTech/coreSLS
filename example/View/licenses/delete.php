    ...
    <div class="container">
        <div class="d-flex flex-columns justify-content-start align-items-center mb-3">
            ...
            <div class="flex-grow-1">
                <a href="<?= $this->getRoute() ?>?license=<?= isset($_GET['license']) ? $_GET['license'] : 'Unknown' ?>" class="nav-link px-2">
                    <h1 class="display-5 fw-lighter m-0">
                        License <span style="font-size: 0.5em;">Delete</span>
                    </h1>
                </a>
            </div>
        </div>
        ...
        <?php else: ?>
            ...
            <?php endif; ?>
            <form action="?license=<?= isset($_GET['license']) ? $_GET['license'] : 'Unknown' ?>" method="post">
                <div class="px-3">
                    <div class="card card-body text-bg-light my-4 d-block" style="border-left-width: 4px;">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p class="m-0">You are about to delete the license <strong><?= isset($_GET['license']) ? $_GET['license'] : 'Unknown' ?></strong>. Are you sure you want to delete this license?</p>
                            </div>
                        </div>
                    </div>
                </div>
